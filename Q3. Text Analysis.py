...
print("""
Analysis 2:
The plot shows the distribution of distinct word counts across all the sentences:""")
fig, ax = plt.subplots()
...
print('''
Analysis 3:
The probability of the word "analytics" occurring after the word "data" is '''
f"{round(data_analytics_count/data_count, 2)}.")
